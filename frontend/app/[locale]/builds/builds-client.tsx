          ...
          <div className="flex gap-3">
            <div className="relative flex-1 max-w-2xl">
              ...
              <Input
                ...
                className="ps-12 pe-12 h-12 text-base border-2 focus:border-primary transition-all"
              />
              {searchInput && (
                <Button
                  variant="ghost"
                  size="sm"
                  className="absolute end-2 top-1/2 transform -translate-y-1/2 h-8 w-8 p-0 hover:bg-destructive/10"
