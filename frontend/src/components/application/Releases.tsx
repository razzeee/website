              ...
              {descriptionSanitized ? (
                <div
                  ...
                  className={clsx(
                    ...
                    !isExpanded &&
                      showCollapseButton &&
                      "before:from-flathub-white before:absolute before:bottom-0 before:start-0 before:h-1/2 before:w-full before:bg-linear-to-t before:content-[''] dark:before:from-flathub-arsenic pointer-events-none",
                  )}
                >
                  <div
