        ...
        {scrollHeight > collapsedHeight && (
          <div
            ...
            className={clsx(
              ...
              !isExpanded &&
                scrollHeight > collapsedHeight &&
                "before:from-flathub-lotion before:absolute before:bottom-0 before:start-0 before:h-1/3 before:w-full before:bg-linear-to-t before:content-[''] dark:before:from-flathub-dark-gunmetal pointer-events-none",
            )}
